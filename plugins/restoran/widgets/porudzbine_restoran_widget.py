...
class PorudzbineRestoranWidget(QtWidgets.QWidget):
    ...
    def __init__(self, korime, parent=None):
        ...
        self.privhati = QtWidgets.QPushButton(QtGui.QIcon(
            "resources/icons/tick-button.png"), "Prihvati porudzbinu")
        self.odbij = QtWidgets.QPushButton(QtGui.QIcon(
            "resources/icons/cross.png"), "Odbij porudzbinu")
        self.dostavljena = QtWidgets.QPushButton(QtGui.QIcon(
            "resources/icons/mail.png"), "Oznaci porudzbinu kao dostavljenu")
        self.hbox_layout.addWidget(self.back)
        self.hbox_layout.addWidget(self.privhati)
        self.hbox_layout.addWidget(self.odbij)
        ...
        self.privhati.clicked.connect(self._on_prihvati)
        self.odbij.clicked.connect(self._on_odbij)
    ...
    def _on_prihvati(self):
        ...
        with open("plugins/restoran/Porudzbine"+narucio+".csv", 'r') as readFile:
            reader = csv.reader(readFile)
            lines2 = list(reader)
        ...
        with open("plugins/restoran/Porudzbine"+narucio+".csv", 'w+',newline='') as writeFile:
            writer = csv.writer(writeFile)
        ...
        message.setText("Uspesno ste prihvatili porudzbinu")
    ...
    def _on_odbij(self):
        ...
        napomena = ""
        dialog = Dialog().getOdbiijDialog(self)
        if dialog.exec_() == QtWidgets.QDialog.Accepted:
            napomena = dialog.get_napomena()

        message = QtWidgets.QMessageBox(self.parent())
        message.setIcon(QtWidgets.QMessageBox.Information)
        message.setText("Uspesno ste odbili porudzbinu")
        message.setWindowTitle("Obavestenje")
        message.setStandardButtons(QtWidgets.QMessageBox.Ok)
        message.exec_()
